...
describe('ReviewForm', () => {
  ...
  beforeEach(() => {
    ...
    //W tym kontekście, mockClear() to metoda dostępna na funkcjach mockujących, 
    //takich jak mockOnSubmit (stworzona za pomocą vi.fn()), która czyści wszystkie wcześniejsze informacje o wywołaniach tej funkcji.
